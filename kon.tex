...
$$\hat{\sigma}_{\hat{\beta}_0} = \sqrt{\hat{\sigma}_{\epsilon^{2}} \cdot \frac{\msum{X_i^{2}}}{n\msum{x_i^{2}}}}, \qquad \hat{\sigma}_{\hat{\beta}_1^{2}} = \sqrt{\frac{\hat{\sigma}_{\epsilon^{2}}}{\msum{x_i^{2}}}}$$\\[-8mm]
